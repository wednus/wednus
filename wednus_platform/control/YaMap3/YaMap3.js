 ...
 */
W.YaMap3 = function(location, callback){var self = this;
    ...
    function addMap(){
		...
		var marker = new YMarker(self.location);
		//marker.addLabel();
	    self.core.addOverlay(marker);
...
W.c.YaMap3.appId = 'wednus_platform';

W.js('http://api.maps.yahoo.com/ajaxymap?v=3.0&appid='+ W.c.YaMap3.appId);
W.module('scavenger');
//! \endcond
 ...
 * 'W.c.YaMap3.key' in YaMap3.js as:
 * \code
 * W.c.YaMap3.key = 'ABQIAAAA03ZOZ6fLoh0uVJ65IOW3xRT2yXp_ZAY8_ufC3CFXhHIE1NvwkxRTZd5iunEbnfpa6qZ4XBVkQbg72Q';
 * \endcode
 ...
 * @test    <a href='../../test/YaMap3.html'>testing constructor & member methods</a>
 *<hr>
 *
