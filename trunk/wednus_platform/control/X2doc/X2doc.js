...
/**
 * \brief    X2doc Constructor
 *
 * @param    url    the URL of the target X resource
 * @see http://xmljs.sourceforge.net/website/documentation-faq.html#faqdocumentimplementationcreatedocument
...
W.X2doc = function(xml){
    // control info.
    this.version = '0.0.1';
    this.name = 'X2doc';
    this.xml = xml?xml:'';
    var doc = new XMLDoc(this.xml);
    this.core = doc.docNode;
};
 ...
 * @test    <a href='../../test/X2doc.html'>testing constructor & member methods</a>
 *<hr>
 *
 ...
 * This example will print 'control name: X2doc', the name of this control.
 * \code
